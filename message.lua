-- [version:tssolarapaid]
-- [translation:trident survival solara paid]
-- [scriptid:tridentsurvivalsolarapaid]
...
do
    ...
    cheat.utility.new_renderstepped(function()
        ...
        if target and spos then
            ...
            snaplinedrawing.From = _Vector2new(Mouse.X, Mouse.Y + GuiInset.Y)
